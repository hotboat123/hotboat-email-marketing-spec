...
from app.routers import auth, contacts, segments, templates, campaigns, webhooks, ses_webhook, analytics, sync, automations, forms, admin, brand_assets, crm, ads, web_traffic, sent_emails, sources
...
from app.models import email_log as _email_log_models  # noqa: registers table
...
app.include_router(web_traffic.router, prefix="/api/web-traffic", tags=["web-traffic"])
